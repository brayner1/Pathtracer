...
namespace Renderer {
	...
	public:
		...
		Mesh(std::vector<Eigen::Vector4f, Eigen::aligned_allocator<Eigen::Vector4f>> vertex_array, 
		...
		Mesh(Eigen::Vector4f* vertex_array, Eigen::Vector3i* index_array,
		...
		bool is_hit_by_ShadowRay(Ray& incoming_ray);
